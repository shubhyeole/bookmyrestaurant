...
%>
<form action="readserviceslink" method="post" style="display:none;">
...
<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x <%=restro.getServiceIcon()%> text-primary mb-4"></i>
                                <h5><%=restro.getServiceName()%></h5>
                                <p><%=restro.getServiceDescription() %>
                                </p>
                            </div>
                        </div>
                    </div>
