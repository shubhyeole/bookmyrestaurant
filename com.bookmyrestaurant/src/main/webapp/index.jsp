...
<body>
	<div class="container-xxl bg-white p-0">
		...
		<div class="container-xxl py-5">
			<div class="container">
				<h3>Services</h3>
				<div class="row g-4" id="services-con">
					<!-- Service End -->
</div>
</div>
</div>
							...
							<div class="row g-5 align-items-center">
								...
								<div class="col-lg-6">
									...
									<p class="mb-4">Tempor erat elitr rebum at clita. Diam
										dolor diam ipsum sit. Aliqu diam amet diam et eos erat ipsum
							...
							<div class="tab-class text-center wow fadeInUp"
								...
								<div class="tab-content">
									<div id="tab-1" class="tab-pane fade show p-0 active">
										<div class="row g-4" id="item-con-b" >
											<div class="col-lg-6">
									...
									<div id="tab-2" class="tab-pane fade show p-0">
										<div class="row g-4" id="item-con-l">
											
										</div>
									</div>
									<div id="tab-3" class="tab-pane fade show p-0">
										<div class="row g-4" id="item-con-d">
						...
						<div class="container">
							...
							<div class="owl-carousel testimonial-carousel">
								<div class="testimonial-item bg-transparent border rounded p-4">
									...
									<p>Dolor et eos labore, stet justo sed est sed. Diam sed
										sed dolor stet amet eirmod eos labore diam</p>
									<div class="d-flex align-items-center">
